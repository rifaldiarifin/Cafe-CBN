        ...
        <div class="header beetw">
            ...
            <div class="searchpage-classic hide">
                <form action="" method="post">
                    ...
                    <input type="text" name="search" id="search" placeholder="Search in Settings">
                </form>
            </div>
            <div class="navbar">
                <div class="nav-list">
                    ...
                    <div class="content-box-2-2 fl-1 pad-20px">
                        <div class="tab-fixd" id="tabFixd1">
                            ...
                            <div id="personalinfo" class="dp-icon-text-auto-atr border-rounded-10px dp-itaa-off frame2">
                                ...
                                <div onclick="HiPrompt('Personal Info', 'Confirm first if this is you', '/admin/openprofile')" class="dp-btn key-option lock">
                            ...
                            <div class="dp-icon-text-auto-atr border-rounded-10px dp-itaa-off frame3">
                                ...
                                <div id="btnsignout" onclick="HiConfirm('Signout', 'Are you sure to exit?', '/admin/signout')" class="dp-btn dp-option">
                                    <div class="i-expand-arrow"></div>
                                </div>
                            </div>
                        </div>
...
<script src="<?= BASEURL; ?>/js/HiPrompt.js"></script>